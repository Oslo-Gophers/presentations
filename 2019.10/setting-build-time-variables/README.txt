...
The version of a program, for example, is a pain to have in in the source code beacuse it's very easy to forget to update it every time you compile a new version.
